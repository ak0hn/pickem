...
export function PicksTicker() {
        ...
        <div className="mx-auto max-w-3xl px-4 py-2 flex items-center gap-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs text-muted-foreground truncate">
              {locked
                ? `You didn't lock Week ${week}`
                : `Lock your Week ${week} picks before kickoff`}
            </div>
          </div>
  ...
  return (
    <Link href="/picks" className="block border-b border-border bg-background/85 backdrop-blur">
