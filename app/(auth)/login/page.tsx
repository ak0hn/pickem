    ...
    <div>
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 mb-4">
          <span className="size-9 rounded-lg bg-primary text-primary-foreground grid place-items-center font-display text-lg">CL</span>
        </div>
        <h1 className="font-display text-3xl">Cover League</h1>
        <p className="text-muted-foreground text-sm mt-1">NFL Pick&apos;em · Against the spread</p>
      </div>
