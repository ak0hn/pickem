  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">No play here.</p>
        <div className="mt-6">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cover League — NFL ATS Pick'em" },
      { name: "description", content: "Pick 6 against the spread. Lock 'em. Cover up." },
    ],
    links: [
